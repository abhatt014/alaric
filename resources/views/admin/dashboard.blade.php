        ...
        @endif
            ...
            <div class="col-xl-3 col-lg-6 col-md-6  mb-4">
                <div class="card bg-dark">
                    <div class="card-body pt-3">
                        <h3 class="card-title mb-3">{{ $totalMonitors }}</h3>
                        <h4 class="card-text">Total Monitors</h4>
                    </div>
                    <div class="card-footer px-4 pt-0 border-0">
                        <a href="#" target="_blank">View</a>
                    </div>
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h2 class="pt-4">Return Requests</h2>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            <table id="html5-extension" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $returnRequest->user->first_name }} {{ $returnRequest->user->last_name }}  </td>
                                        <td>{{ $returnRequest->user->email??'' }}</td>
                                        <td>{{ $returnRequest->asset->assetType->type_name??'' }}</td>
                                        <td>{{ $returnRequest->asset->asset_name??'' }} ({{  $returnRequest->asset->asset_serial??'' }})</td>
                                        <td>{{ \Carbon\Carbon::parse($returnRequest->created_at)->format('d-M-Y') }}</td>
                                        <td><span class="badge badge-warning">{{ $returnRequest->status??'' }}</span></td>
                                        <td>        
                                            {{--  --}}
                                            <a class="btn btn-primary" href="{{  route('admin.viewreturns', $returnRequest->id)  }}">View</a>
