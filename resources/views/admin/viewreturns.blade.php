...
@section('maincontent')
    <div class="layout-px-spacing">
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <form enctype="multipart/form-data" action="{{ route('admin.processreturn',$assetReturnRequest->id) }}" method="post">
                @csrf
                <div class="row mb-4 layout-spacing layout-top-spacing">
                    ...
                    <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="widget-content widget-content-area blog-create-section">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-4">
                                    <label>Condition</label><span style="color: red">*</span><br/>
                                    <input class="form-check-input" type="radio" name="condition" id="form-check-radio-success" value="acceptable" required>
                                    <label class="form-check-label" for="form-check-radio-success" >
                                        Acceptable
                                    </label>
                                    <input class="form-check-input" type="radio" name="condition" id="form-check-radio-danger" value="unacceptable" required>
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-4">
                                    <label>Department Notes</label><span style="color: red">*</span>
                        ...
                        <div class="widget-content widget-content-area blog-create-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-12 col-md-12 mb-4">
                                    ...
                                    <label for="asset-images">Upload Images</label><span style="color: red">*</span>
                                    <input type="file" name="image_path[]" id="asset-images" multiple="" class="form-control " required="">
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="fqheading{{ $activity->id }}">
                                                <div class="mb-0" data-bs-toggle="collapse" role="navigation"
                                                    ...
                                                    <span class="faq-q-title">{{ Carbon\Carbon::parse($activity->action_date)->diffForHumans() }} 
                                                        <span class="badge badge-light-secondary"> Asset {{ $activity->action }} </span> 
                                            ...
                                            <div id="fqcollapse{{ $activity->id }}" class="collapse"
                                                aria-labelledby="fqheading{{ $activity->id }}" data-bs-parent="#activity">
                                                <div class="card-body">
                                                    <p>Details: {{ $activity->notes}}</p>
                                                    <p>Images:
                                                        @if ($activity->images)
                                                            @foreach ( json_decode($activity->images) as $image )
                                                            <img src="{{ asset('uploads/assets/' . $image) }}" width="15%" height="15%" target="_blank"> 
                                                            @endforeach
                                                        @endif
                                                    </p>
