                        ...
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                ...
                                <div class="media-body">
                                    ...
                                    <h5>{{ Auth::guard('web')->user()->first_name }}</h5>
                                    <p>{{ Auth::guard('web')->user()->employee_id }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown-item">
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="#" class="nav-link"> ALARIC IT </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu @yield('assignasset-active')">
                        {{-- {{ route('admin.assign') }} --}}
                        <a href="{{ route('user.return') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
