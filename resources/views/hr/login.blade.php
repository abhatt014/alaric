...
<head>
    ...
    <title>ALARIC IT MANAGEMENT | Employee Portal</title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('hr.authenticate') }}" method="POST">
                                @csrf
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-12">
                                    <div class="mb-4">
                                        <button class="btn  btn-social-login w-100">
                                            <img src="{{ asset('src/assets/img/microsoft_logo.svg')}}" alt="" class="img-fluid">
                                            <span class="btn-text-inner">Microsoft</span>
                                        </button>
                                    </div>
                                </div>
