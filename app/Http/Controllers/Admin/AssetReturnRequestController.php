...
class AssetReturnRequestController extends Controller
{
    ...
    public function store( Request $request, AssetReturnRequest $assetReturnRequest){
        ...
        // dd($assetReturnRequest);
         $data = "Return Accepted by Admin from user: ($userinfo->first_name $userinfo->last_name $userinfo->email)| Condition: $request->condition";
        ...
        return redirect()->route('admin.dashboard')->with('success', 'Admin Approved Return request Procesed successfully.');
